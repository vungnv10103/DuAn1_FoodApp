...
public class CartSystemModule {
    ...
    public CartSystemModule(int id, int idRecommend, String img, int idUser, int check,int checkSelected, String name, Double cost,Double costNew,int quantitiesNew, int quantities) {
        this.id = id;
